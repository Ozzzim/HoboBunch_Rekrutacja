...
public class GameResourcesList : MonoBehaviour
{
    ...
    //===== New =====//
    public bool HasResource(GameResourceSO grso, int comparedAmount=0)
    {
        var resource = resources.Find((x) => x.resourceSO == grso);
        return resource!=null && resource.amount > comparedAmount;
    }
}
